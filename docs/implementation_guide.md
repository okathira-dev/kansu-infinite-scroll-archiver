...
| **アイコンライブラリ**           | [Radix UI Icons](https://icons.radix-ui.com/)              | Radix UIエコシステムとの統合性が高く、一貫性のあるアイコンデザインを提供するため。        |
...
- **Background Service (`entrypoints/background/index.ts`)**:
...
- **Options UI (`entrypoints/options/index.tsx`)**:
